...
export default async function InstellingenPage() {
  ...
  const [{ data: profiel }, { data: doelen }, { data: vakanties }, { data: resultaten }] = await Promise.all([
  ...
  return <InstellingenClient profiel={profiel} doelen={doelen ?? []} vakanties={vakanties ?? []} resultaten={resultaten ?? []} />
}
