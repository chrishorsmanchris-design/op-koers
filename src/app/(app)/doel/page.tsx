...
export default function DoelPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f] flex flex-col p-4 pt-8 pb-24">
      {/* Progress */}
      {stap !== 'klaar' && (
        ...
        {stap === 'type' && (
          <div className="flex flex-col gap-4">
            <div>
              ...
              <p className="text-[#6b7280] mt-1">Kies wat je wilt gaan bereiken</p>
            </div>
              ...
              {DOEL_TYPES.map(t => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#6b7280]">{t.beschrijving}</p>
                  </div>
                </button>
              ))}
            </div>
        ...
        {stap === 'details' && (
          <div className="flex flex-col gap-5">
            <div>
              ...
              <p className="text-[#6b7280] mt-1">Wanneer en wat is je doel?</p>
            </div>
        ...
        {stap === 'niveau' && (
          <div className="flex flex-col gap-5">
            <div>
              ...
              <p className="text-[#6b7280] mt-1">Helpt ons het schema goed te kalibreren</p>
            </div>
            ...
            <Card>
              <div className="flex flex-col gap-3">
                <select value={nieuwR.type} onChange={e => setNieuwR({ ...nieuwR, type: e.target.value })}
                  className="bg-[#242424] text-white rounded-xl px-3 py-2.5 border border-[#333] focus:outline-none text-sm">
            ...
            {vakanties.map((v, i) => (
              <Card key={i} className="flex justify-between items-center py-3">
                <div>
                  ...
                  <p className="text-xs text-[#6b7280]">{v.start_datum} → {v.eind_datum}</p>
